...
public class Cls_Salida {
    ...
    private final String SQL_SELECT_SALIDA = "SELECT sal_factura,pro_descripcion, sal_fecha, sal_pro_codigo, sal_cantidad,pro_precio FROM salida INNER JOIN producto ON sal_pro_codigo = pro_codigo";
