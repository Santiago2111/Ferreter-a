...
public class Cls_Productos {
    ...
    private final String SQL_INSERT_PRODUCTOS = "INSERT INTO producto (pro_codigo,pro_descripcion,pro_precio) values (?,?,?)";
    ...
    public int registrarProducto(String codigo, String descripcion, int precio) {
        int res = 0;
        try {
    ...
    public int actualizarProducto(String codigo, String descripcion, String codigo_old, int precio) {
        String SQL = "UPDATE producto SET pro_codigo='" + codigo + "',pro_descripcion='" + descripcion +"',pro_precio='" + precio + "' WHERE pro_codigo='" + codigo_old + "'";
        int res = 0;
        try {
